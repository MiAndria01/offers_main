            ...
            <div className="row">
                ...
                <div className="col-lg-5">
                    <div className="offers_content">
                        <div className="offers_price">{lieuDepart} - {lieuArriver}</div>
                        ...
                        <p className="offers_text">Trajet régulier en semaine. {nbPassage} places disponibles. Voiture propre, conducteur courtois.</p>
